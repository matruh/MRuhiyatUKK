...
<head>
    ...
    <title>CRUD Laravel - Tambah Koleksi Buku</title>
...
<body>
    ...
    <main>
        ...
        <div class="container">
            <h2 class="text-center mt-5">Tambah Koleksi Pribadi Saya</h2>
                <div class="container my-4">
                    <form action="{{ route('proseskoleksi') }}" method="POST">
                        @csrf
                            ...
                            @foreach ($buku as $book)
                                <div class="col">
                                    <div class="card h-100 shadow-sm">
                                        @if ($book->foto)
                                            <img src="{{ asset('fotobuku/' . $book->foto) }}" class="card-img-top mx-auto d-block mt-5"
                                                alt="{{ $book->judul }}"
                                                style=" width:200px; height: 300px; object-fit: cover;">
                                        @else
                                            <img src="{{ asset('fotobuku/default.jpg') }}" class="card-img-top mx-auto d-block mt-5"
                    ...
                    <button type="submit" class="btn btn-primary mt-5">Tambah koleksi</button>
