...
<body>
    ...
    <div class="container my-5">
        <h1 class="text-center">Data Daftar User</h1>
        <div class="row mb-4">
            <div class="col-md-auto">
                <a href="/tambahuser" class="btn btn-success w-100">Tambah User</a>
            </div>
            <div class="col-md-auto">
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Tanggal Verifikasi Email</th>
                ...
                <tbody>
                    ...
                    @foreach ($user as $no =>$datauser)
                        <tr>
                            ...
                            <td>
                                <a href="/edituser/{{ $datauser->id }}" class="btn btn-info btn-sm">Edit</a>
                                <a href="/hapususer/{{ $datauser->id }}" class="btn btn-danger btn-sm">Hapus</a>
                            </td>
                        </tr>
                    @endforeach
